      ...
      <TooltipProvider>
        ...
        <Router>
          ...
          <Routes>
            ...
            <Route path="/recharge-bills" element={<DTHWifiMobileRecharge />} />
            <Route path="/bill-payment" element={<ElectricityBillPayment />} />
            <Route path="/credit-card-bills" element={<CreditCardBillPayment />} />
